  ...
  return (
    <Paper className={classes.sideWrap}>
      ...
      <div className={classes.separator}>
        <Typography><FormattedMessage {...messages.orLoginWith} /></Typography>
      </div>
      <div className={classes.socmedFull}>
        <Button variant="outlined" size="small" className={classes.socialBtn} onClick={googleAuth}>
          <Icon className={classes.socialIcon}>google</Icon>
          Google
        </Button>
        <Button variant="outlined" size="small" className={classes.socialBtn} onClick={twitterAuth}>
          <Icon className={classes.socialIcon}>twitter</Icon>
          Twitter
        </Button>
        <Button variant="outlined" size="small" className={classes.socialBtn} onClick={githubAuth}>
          <Icon className={classes.socialIcon}>github</Icon>
          Github
        </Button>
      </div>
    </form>
